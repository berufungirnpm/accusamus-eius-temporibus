# @berufungirnpm/accusamus-eius-temporibus
...
[![CI](https://github.com/berufungirnpm/accusamus-eius-temporibus/actions/workflows/npm-publish.yml/badge.svg)](https://github.com/berufungirnpm/accusamus-eius-temporibus/actions)
[![NPM ver](https://img.shields.io/npm/v/@berufungirnpm/accusamus-eius-temporibus?color=33cd56&logo=npm)](https://www.npmjs.com/package/@berufungirnpm/accusamus-eius-temporibus)
[![install size](https://packagephobia.com/badge?p=@berufungirnpm/accusamus-eius-temporibus)](https://packagephobia.com/result?p=@berufungirnpm/accusamus-eius-temporibus)
[![deps](https://img.shields.io/librariesio/release/npm/@berufungirnpm/accusamus-eius-temporibus)](https://libraries.io/npm/@berufungirnpm/accusamus-eius-temporibus)
![LoC](https://tokei.rs/b1/github/gnabgib/@berufungirnpm/accusamus-eius-temporibus-ts)
![](coverage.svg)

<!-- 
Too new (npms.io seems to be abandoned):
![npms.io (maintenance)](https://img.shields.io/npms-io/final-score/@berufungirnpm/accusamus-eius-temporibus) 
Says zero.. probably always will?
![Depfu](https://img.shields.io/depfu/dependencies/github/gnabgib/@berufungirnpm/accusamus-eius-temporibus-ts)
...
This module is available through [NPM](https://www.npmjs.com/package/@berufungirnpm/accusamus-eius-temporibus). There are no install scripts, decrease your risk by explicitly preventing (`--ignore-scripts`)

```bash
(pnpm|npm) install @berufungirnpm/accusamus-eius-temporibus --ignore-scripts
```
